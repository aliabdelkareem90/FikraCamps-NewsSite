...
// we should install babel-polyfill and import it to make parcel support async
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://newsapi.org/v2/everything?q=".concat(query, "&apiKey=ea74d2ab35164ad9b48bb00d80a22edd"));
...
function createArticle(article, i) {
  article.counter = 0;
  return "\n        <article id=\"".concat(i, "\">\n            <div>\n                <img src=\"").concat(article.urlToImage, "\" alt=\"\" height=\"124\" width=\"124\">\n            </div>\n            <div class=\"article-text\" id=\"text\">\n                <h3>").concat(article.title, "</h3>\n                <p>").concat(article.description, "</p>\n                <time>").concat(article.publishedAt, "</time>\n            </div>\n            <div id=\"voter\">\n                <img height=\"13px\" id=\"up\" src=\"").concat(require('./assets/upvote.svg'), "\" alt=\"\" onclick=\"changeCount('counter").concat(i, "', 'up')\">\n                <div id=\"counter").concat(i, "\">").concat(article.counter, "</div>\n                <img height=\"13px\" src=\"").concat(require('./assets/downvote.svg'), "\" alt=\"\" onclick=\"changeCount('counter").concat(i, "', 'down')\">\n            </div>\n        </article>\n    ");
}

window.changeCount = function (id, btnId) {
  if (btnId == 'up') {
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./assets/upvote.svg":"assets/upvote.svg","./assets/downvote.svg":"assets/downvote.svg"}],"C:/Users/Ali/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/Ali/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
